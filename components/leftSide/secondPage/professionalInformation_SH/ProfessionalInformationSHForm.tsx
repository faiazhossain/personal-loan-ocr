  ...
  useEffect(() => {
    if (getOcrData.length > 0) {
      form.setFieldsValue({
        ...
        sh_department: getOcrData[1]?.text?.applicant_employeer_department,
        sh_designation: getOcrData[1]?.text?.applicant_employeer_designation,
        sh_current_year: getOcrData[1]?.text?.applicant_length_of_service?.split(" ")[0],
        sh_current_month: getOcrData[1]?.text?.applicant_length_of_service?.split(" ")[1],
