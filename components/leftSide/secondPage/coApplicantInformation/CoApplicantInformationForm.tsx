...
const CoApplicantInformationForm = () => {
  ...
  return (
    <>
      ...
      <Form.Item name="co_applicant_employment_status" label="Employment Status">
        <Radio.Group onChange={handleEducationLevelChange}>
      ...
      <Form.Item<FieldType>
        label="E-TIN"
        name="co_applicant_etin"
      >
        <Input 
        type="number"
        />
      </Form.Item>
      <Form.Item name="co_applicant_identification_document" label="Identification Document">
            <Input />
          </Form.Item>
        </>
  );
